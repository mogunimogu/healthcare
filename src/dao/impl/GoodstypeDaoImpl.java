...
public class GoodstypeDaoImpl extends HibernateDaoSupport implements GoodstypeDao{
	private static final Logger log = LoggerFactory
			.getLogger(GoodstypeDaoImpl.class);
	// property constants
	...
	public List<Goodstype> findByExample(Goodstype instance) {
		...
		try {
			List<Goodstype> results = (List<Goodstype>) getHibernateTemplate()
	...
	public static GoodstypeDaoImpl getFromApplicationContext(ApplicationContext ctx) {
		return (GoodstypeDaoImpl) ctx.getBean("GoodstypeDAO");
	}
}