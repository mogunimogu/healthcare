...
public class ShoppingCartDaoImpl extends HibernateDaoSupport implements ShoppingCartDao{
	...
	public List<ShoppingCart> findByExample(ShoppingCart instance) {
		...
		try {
			List<ShoppingCart> results = (List<ShoppingCart>) getHibernateTemplate()
	...
	public List<ShoppingCart> findBySCount(Object SCount) {
		return findByProperty(_SCOUNT, SCount);
	}

	public List<ShoppingCart> findBySPrice(Object SPrice) {
	...
	public static ShoppingCartDaoImpl getFromApplicationContext(
			ApplicationContext ctx) {
		return (ShoppingCartDaoImpl) ctx.getBean("ShoppingCartDAO");
	}
}